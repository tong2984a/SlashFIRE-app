...
import BuyWrapper from './buySection.style';
...
import { UserContext } from '../../../pages/buy'
            ...
            <Box marginRight="auto" marginLeft="auto" width={"80%"}>
              <Box className="row" {...row}>
                  ...
                  <GlideCarousel
                    ...
                    nextButton={
                      <Button
                        ...
                        aria-label="Next"
                        variant="textButton"
                        {...BuySection.defaultProps.glideBtnStyle}
                      />
                    }
                    prevButton={
                      <Button
                ...
                <Box {...col2} className="col membership_nft-info">
                  ...
                  <Button title="Buy Now" {...btnStyle} onClick={() => handleBuy(nfts[currentNftIndex])}>Buy Now</Button>
                </Box>
              </Box>
            </Box>
          </Box>
